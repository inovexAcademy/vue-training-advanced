...
<template>
  <div class="root">
    ...
    <ul v-if="productsStore.validProducts?.length > 0" data-testid="product-list">
      <li v-for="product in productsStore.products" :key="product.id" data-testid="product-item">
        <ProductCard
          :id="product.id"
          :title="product.title"
